#ifndef INTERFACE_INPUT_SYSTEM_H
#define INTERFACE_INPUT_SYSTEM_H
#pragma once
...
struct IMouse
{
    ...
    virtual void        ResetScrollWheelValue() noexcept = 0;
    virtual void        SetMode(MouseMode mode) = 0;
...
struct IInputSystem
{
    ...
    virtual void        ProcessMessage(InputType type, UINT message, WPARAM wParam, LPARAM lParam) = 0;

};

#endif //INTERFACE_INPUT_SYSTEM_H
